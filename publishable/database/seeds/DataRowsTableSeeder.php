    ...
    public function run()
    {
        ...
        if (!$dataRow->exists) {
            $dataRow->fill([
                ...
                'add'          => 1,
                'delete'       => 0,
                'details'      => '{"model":"TCG\\\Voyager\\\Models\\\Role","table":"voyager_roles","type":"belongsToMany","column":"id","key":"id","label":"display_name","pivot_table":"voyager_user_roles","pivot":"1","taggable":"0"}',
                'order'        => 11,
            ])->save();
        }
